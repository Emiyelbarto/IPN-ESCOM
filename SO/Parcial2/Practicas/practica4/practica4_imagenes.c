...
void process_png_file_red(){
	...
	png_byte GRAY130[] = {130,130,130};
	png_byte GRAY140[] = {140,140,140};
	png_byte GRAY150[] = {150,150,150};
  	...
  	for (unsigned int y = 0; y < height; y++) {
    	...
    	for (unsigned int x = 0; x < width; x++) {
      		...
      		for(int i = 0; i < 3; ++i){
        		if(px[i] != BLACK[i] && px[i] != WHITE[i] && px[i] != GRAY70[i] && px[i] != GRAY80[i] && px[i] != GRAY90[i] && px[i] != GRAY100[i] && px[i] != GRAY110[i] && px[i] != GRAY120[i] && px[i] != GRAY130[i] && px[i] != GRAY140[i] && px[i] != GRAY150[i])
		        	px[i] = RED[i];
    		}     
        }
