...
public class Tetraedro {
    ...
    private float[] vertices = { // 5 vertices of the pyramid in (x,y,z)
            -1.0f,  0.0f,  -1.0f,  // 0. left-bottom-back
            -1.0f,  0.0f,  1.0f,  // 1. right-bottom-back
            0.0f,  0.0f,  1.0f,  // 2. right-bottom-front
            1.0f,  0.0f,  0.0f,  // 3. left-bottom-front
    ...
    private float[] colors = {  // Colors of the 5 vertices in RGBA
            1.0f, 0.0f, 1.0f, 1.0f,  // 0. magenta
            0.0f, 1.0f, 0.0f, 1.0f,  // 1. green
            0.0f, 1.0f, 1.0f, 1.0f,  // 2. cyan
