                ...
                <div class="col-md-12">
                  <div class="page-header-toolbar">
                    ...
                    <div class="filter-wrapper">
                      ...
                      <a href="#" class="advanced-link toolbar-item"
                        >Advanced Options</a
                      >
                    </div>
                        ...
                        <div class="data-wrapper d-flex mt-2 mt-lg-0">
                          <div class="wrapper pr-5">
                            ...
                            <div class="d-flex align-items-center">
                              ...
                              <small class="ml-2 text-gray d-none d-lg-block"
                                ><b>89.5%</b> of 20,000 Total</small
                              >
                            </div>
                          </div>
                          <div class="wrapper">
                            ...
                            <div class="d-flex align-items-center">
                              ...
                              <small class="ml-2 text-gray d-none d-lg-block"
                                ><b>10.5%</b> of 20,000 Total</small
                              >
                            </div>
                          </div>
                        </div>
                  ...
                  <div class="card">
                    <div class="card-body d-flex flex-column">
                      <div class="wrapper">
                        ...
                        <div id="net-profit-legend" class="mb-4"></div>
                      </div>
                      <canvas
                        id="net-profit"
                      ...
                      <div class="card">
                        <div class="card-body">
                          ...
                          <div class="d-flex align-items-end">
                            ...
                            <p class="mb-0 font-weight-medium mr-2 ml-2 mb-1">
                              USD
                            </p>
                            <p
                    ...
                    <div class="col-md-12 grid-margin">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <p>
                            Lorem ipsum dolor sit amet, consectetur adipisicing
                            elit. Est quod cupiditate esse fuga
                          </p>
                        ...
                        <div class="card-body">
                          ...
                          <div class="row mt-5">
                            <div class="col-6">
                              ...
                              <p>Since last week</p>
                              <p>
                                <span class="font-weight-medium">0.51%</span>
                                (30 days)
                              </p>
                            </div>
                            <div class="col-6">
                      ...
                      <ul class="timeline">
                        <li class="timeline-item">
                          <p class="timeline-content">
                            <a href="#">Ben Tossell</a> assign you a task
                          </p>
...
<script src="static/js/demo_1/dashboard.js"></script>
